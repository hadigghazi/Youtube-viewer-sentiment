...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    # Use your actual tracking server (or rely on env MLFLOW_TRACKING_URI)
    mlflow.set_tracking_uri(os.getenv(
        "MLFLOW_TRACKING_URI",
        "http://ec2-54-159-96-0.compute-1.amazonaws.com:5000/"
    ))
    model_uri = f"models:/{model_name}/{model_version}"   # or .../Production
    # Load as sklearn so your existing predict(...) continues to work
